...
public final class SpanUtils {
     ...
     * 设置点击事件
     * <p>
     * <p>需添加view.setMovementMethod(LinkMovementMethod.updateInstance())</p>
     *
    ...
    private void updateCharCharSequence() {
        ...
        if (iconMarginGapWidth != -1) {
            ...
            if (iconMarginBitmap != null) {
                ...
                mBuilder.setSpan(new CustomIconMarginSpan(getApplication(), iconMarginUri, iconMarginGapWidth, alignIconMargin), start, end, flag);

            } else if (iconMarginResourceId != -1) {

                mBuilder.setSpan(new CustomIconMarginSpan(getApplication(), iconMarginResourceId, iconMarginGapWidth, alignIconMargin), start, end, flag);
    ...
    private void updateImage() {
        ...
        if (imageBitmap != null) {
            ...
            mBuilder.setSpan(new CustomImageSpan(getApplication(), imageBitmap, alignImage), start, end, flag);
            ...
            mBuilder.setSpan(new CustomImageSpan(getApplication(), imageUri, alignImage), start, end, flag);

        } else if (imageResourceId != -1) {

            mBuilder.setSpan(new CustomImageSpan(getApplication(), imageResourceId, alignImage), start, end, flag);
