...
public class MVPCreator {
	...
	private String createInterfacePresenter(){
		...
		return String.format(IPRESENTER,name.toLowerCase(),name+"Presenter",parents+"Presenter",name+"View");
	}

	private String createActivity(){

		return String.format(PRESENTER,name.toLowerCase(),name+"Activity",parents+"Activity",name+"View",name+"Presenter");
	}

	private String createFragment(){

		return String.format(PRESENTER,name.toLowerCase(),name+"Fragment",parents+"Fragment",name+"View",name+"Presenter");
	}

	private String createInterfaceView(){

		return String.format(IVIEW,name.toLowerCase(),name+"View",parents+"View",name+"Presenter");
	}

	private String createView(){

		return String.format(VIEW,name.toLowerCase(),name+"View",parents+"View",name+"Presenter",name+"View");
	}
	...
	private static String IPRESENTER = packageName+"%s;"+"\n\n"+"public interface I%s extends I%s<I%s> {\n" +
			"}";

	private static String PRESENTER = packageName+"%s;"+"\n\n"+"public class %s extends %s<I%s> implements I%s {\n" +
			"}";

	private static final String IVIEW = packageName+"%s;"+"\n\n"+"public interface I%s extends I%s<I%s> {\n" +
			"}";

	private static final String VIEW = packageName+"%s;"+"\n\n"+"public class %s extends %s<I%s> implements I%s {\n" +
			"}";
