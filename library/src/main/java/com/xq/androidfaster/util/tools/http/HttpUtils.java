...
public final class HttpUtils {
    ...
    public static Response callSync(@NonNull final Request request){
        return new Call(request,null).getResponse();
    }
    ...
    static class Call implements Runnable {
        ...
        public Response getResponse(){
            ...
            try {
                ...
                if (responseCode == 200) {
                    ...
                    is.close();
                    return new Response(conn.getHeaderFields(), is);
                    ...
                    throw  new Exception(new NetworkErrorException("error code: " + responseCode +
        ...
        public void run() {
            ...
            try {
                ...
                if (responseCode == 200) {
                    InputStream is = conn.getInputStream();
                    callback.requestSuccess(new Response(conn.getHeaderFields(), is));
                    is.close();
                } else if (responseCode == 301 || responseCode == 302) {
                    String location = conn.getHeaderField("Location");
